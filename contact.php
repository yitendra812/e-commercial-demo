...
<html>
    <head>
        <title>E-Store(all type of commercial)|Contact Us</title>
    ...
    <body>
        ...
        <div class="container"><br><br><br><br>
			<div class="row">
				<div class="col-sm-10">
				  <h1>LIVE SUPPORT</h1>
				  <h3>24*7| 365 days a year Live Technical Support</h3>
				  <div>
			...
			<div class="row">
				<div class="col-sm-8">
					...
					<form>		
						...
						<div class="form-group">
							<textarea name="message" id="message" required="required" class="form-control" rows="5" placeholder="Your Message/suggestion Here"></textarea>
						</div>
